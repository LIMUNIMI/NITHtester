...
namespace NITHtester.Elements
{
    internal class BindableGauge
    {
        ...
        public BindableGauge(ProgressBar prbValue, ComboBox cbxArg, TextBox txtMin, TextBox txtMax, TextBox txtOffset, CheckBox chkUseProp)
        {
            ...
            foreach (string item in Enum.GetNames(typeof(NithArguments)))
            {
        ...
        public NithArguments Argument { get; private set; } = NithArguments.NaA;

        public double Max { get; private set; } = 100;

        public double Min { get; private set; } = 0;

        public NithArgumentValue NithArgVal { get; private set; } = new NithArgumentValue(NithArguments.NaA, "");
        ...
        {
            Argument = (NithArguments)Enum.Parse(typeof(NithArguments), cbxArg.SelectedItem.ToString());
        }
